...
class ValidateA3clientepf extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            // "cpf"=> "formato_cpf|cpf|required|unique:a3clientepf,cpf".(!empty($this->id) ? ','.$this->id : ''),
            // "nome"=>"string|max:64|required",
            "nome"=> "required|unique:a3clientepf,nome".(!empty($this->id) ? ','.$this->id : ''),
