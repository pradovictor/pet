...
@section('content')
@if(Auth::user()->can('PRECADASTRO3-FORMULARIO-A') || Auth::user()->can('PRECADASTRO3-FORMULARIO-E'))
<div id="form-modal-formulario" class="form-modal modal fade" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-formulario" method="POST" action="{{config('app.url')}}/action/aplicativo3/precadastro/formulario" onsubmit="return false;"
            ...
            <div class="modal-footer">
                ...
                <button id="saveform-formulario" type="button" class="btn btn-primary">Salvar</button>
...
<script type="text/javascript">
    var simpleCRUDObj = SimpleCRUD.load({
        dataTables: {
            ...
            formEntity: "form-formulario",
            editType: "modal",
            addType: @if(Auth::user()->can('PRECADASTRO3-FORMULARIO-A')) "modal" @else "none" @endif,
            addButtonText: "Adicionar Formulario",
            urls: {
                list: "{{config('app.url')}}/action/aplicativo3/precadastro/formulario/list",
                delete: "{{config('app.url')}}/action/aplicativo3/precadastro/formulario/delete/",
                edit: "{{config('app.url')}}/action/aplicativo3/precadastro/formulario/editar/",
                add: "{{config('app.url')}}/action/aplicativo3/precadastro/formulario/novo"
            }
        }
    });
    ...
    @if(Auth::user()->can('PRECADASTRO3-FORMULARIO-A') || Auth::user()->can('PRECADASTRO3-FORMULARIO-E'))
        $('#form-formulario').parsley().on('form:success', function () {
            Nitsys.saveForm('form-formulario', simpleCRUDObj);
        });
        $('.form-modal').on('hidden.bs.modal', function (e) {
            Nitsys.clearForm('form-formulario');
            $('#form-formulario').parsley().reset();
